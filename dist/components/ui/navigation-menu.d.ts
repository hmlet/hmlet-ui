...
declare function NavigationMenuContent({ className, loading, apiError, emptyText, children, ...props }: NavigationMenuContentProps): import("react/jsx-runtime").JSX.Element;
