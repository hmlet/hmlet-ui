...
declare function Select({ loading, apiError, emptyText, isSearchable, searchFn, searchPlaceholder, children, ...props }: SelectProps): import("react/jsx-runtime").JSX.Element;
